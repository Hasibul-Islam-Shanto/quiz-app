                ...
                <div className="space-y-4">
                  ...
                  <div id="optionsContainer" className="space-y-2 mt-4">
                    <div className="flex items-center space-x-2 px-4 py-1 rounded-md group focus-within:ring focus-within:ring-primary/80 bg-white">
                      ...
                      />
                      <label className="sr-only">Option 1</label>
                      <input
                        type="text"
                        id="optionText0"
                        name="optionText0"
                    ...
                    <div className="flex items-center space-x-2 px-4 py-1 rounded-md group focus-within:ring focus-within:ring-primary/80 bg-white">
                      <input
                        ...
                        className="text-primary focus:ring-0 w-4 h-4"
                      />
                      <label className="sr-only">Option 2</label>
                      <input
                        type="text"
                        id="optionText2"
                        name="optionText2"
                    ...
                    <div className="flex items-center space-x-2 px-4 py-1 rounded-md group focus-within:ring focus-within:ring-primary/80 bg-white">
                      <input
                        ...
                        className="text-primary focus:ring-0 w-4 h-4"
                      />
                      <label className="sr-only">Option 3</label>
                      <input
                        type="text"
                        id="optionText3"
                        name="optionText3"
                    ...
                    <div className="flex items-center space-x-2 px-4 py-1 rounded-md group focus-within:ring focus-within:ring-primary/80 bg-white">
                      <input
                        ...
                        className="text-primary focus:ring-0 w-4 h-4"
                      />
                      <label className="sr-only">Option 4</label>
                      <input
                        type="text"
                        id="optionText4"
                        name="optionText4"
